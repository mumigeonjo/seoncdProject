...
<!--             
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Question 수정하기
      </h1>
      ...
      <div class="mb-4" id="accordion" role="tablist" aria-multiselectable="true">
  	 	...
  	 	<form name="userQAUpdateForm" method="post" action="mumi?command=userQAUpdate" onSubmit='return sendUpdate()'>
  	 	  <fieldset style="text-align: center;">
  	 	    <font style = "vertical-align : inherit; font-size:20pt;"> 양식 </font>
   			  <div>
			    <label for="exampleTextarea">Question 제목</label>
			    <textarea class="form-control" id="bTitle" name="bTitle" rows="1">${userQAUpdate.bTitle}</textarea>
			  </div>
			  
			  <div style="margin:0px 0px 10px">
			    <label for="exampleTextarea">Question 내용</label>
			    <textarea class="form-control" id="bContent" name="bContent" rows="3">${userQAUpdate.bContent}</textarea>
			  </div>
  	 	  	  <input type=hidden name="bIndexNo" value="${userQAUpdate.bIndexNo}">
  	 	  	  <input type=hidden name="bCategory" value="${userQAUpdate.bCategory}">
