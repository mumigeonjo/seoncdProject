...
<!--             
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Question Answer 추가하기
      </h1>
      ...
      <div class="mb-4" id="accordion" role="tablist" aria-multiselectable="true">
  	 	...
  	 	<form name="userQAUpdateForm" method="post" action="mumi?command=adminQAReplyInsert" onSubmit='return sendUpdate()'>
  	 	  <fieldset style="text-align: center;">
  	 	    <font style = "vertical-align : inherit; font-size:20pt;"> 양식 </font>
			  
			  <div style="margin:0px 0px 10px">
			    <label for="exampleTextarea">Question Answer 내용</label>
			    <textarea class="form-control" id="qContent" name="qContent" rows="3"></textarea>
			  </div>
			  <input type=hidden name="bIndexNo" value="${bIndexNo}" id="bIndexNo">
  	 	  	  <button type = "submit" class = "btn btn-primary" style = "vertical-align : inherit;">추가하기</button>
